...
├── learnixa-frontend/ # React (Vite) frontend
└── README.md
...
```bash
git clone https://github.com/Samikshyaneupane/learnixa.git
...
# Frontend
cd learnixa-frontend
npm install
npm run dev
```

Built as a final year project for Nepathya College, Tribhuvan University.
